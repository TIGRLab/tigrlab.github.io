...
+ NOTE: Each site is assigned a numeric code in their project title (e.g., PRE07). The participants uploaded to this project should always use the numeric code 01, regarless of the project number (PRE01_ZHH_0023_01_01).
...
Uploading Non-DICOM Data (Behavioural Data, Physiological Data, Tech Notes, Patient Logs, etc).
-----------------------------------------------------------------------------------------------
